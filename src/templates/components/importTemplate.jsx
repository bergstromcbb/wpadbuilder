				...
				<div className="topHeaderContainer ribbon row p-0">
					<div className="headerItemLeft ">
						<ul className="breadcrumb">
							...
							<li><Link to="/templates" activeClassName="active">Templates</Link></li>
							<li><Link to="/importTemplate" activeClassName="active">Import Template</Link></li>
						</ul>
						<p className="panel-title teal all-caps threeHundred">Import Template</p>
					</div>
						...
						<div className="panel-heading ">
							<div className="panel-title semi-bold teal">
								<span className="categorytitle">
									...
									<span className="p-l-10">Import Your Template</span>
								</span>
							</div>
						</div>
								...
								<form id="form-work" role="form" autoComplete="off" noValidate="noValidate">
									<div className="form-group-attached">
										<div className="form-group form-group-defaultx required">
											<label className="invitelabel">Template Name</label>
											<input type="text" className="form-control" id="fname" placeholder="Template Name" name="name" required="required" aria-required="true" />
										</div>
									</div>
									<div className="form-group-attached">
										<div className="form-group form-group-defaultx required">
